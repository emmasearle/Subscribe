var flxpxlObj = (function() {
	...
	obj.execute = function() {
		...
		var conditions_577566 = {};
		setTimeout(function() {
		function pageGroup_577566() {
			obj.placeAppNexusSegmentScript('seg?add=2175820&t=1', null, null, null, 'None', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_577566[queryId]=true);if(checkConditions(conditions_577566)){pageGroup_577566();}});};
		if(
			(window.location.href != '')
		) {
			if(checkConditions(conditions_577566)){pageGroup_577566();}
		}
		}, 1);

		// Page group: Organic
		var conditions_577567 = {};
		setTimeout(function() {
		function pageGroup_577567() {
			obj.placeAppNexusSegmentScript('seg?add=2175822&t=1', null, null, null, 'Organic', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_577567[queryId]=true);if(checkConditions(conditions_577567)){pageGroup_577567();}});};
		if(
			(flxKeyword != '')
		) {
			if(checkConditions(conditions_577567)){pageGroup_577567();}
		}
		}, 1);
...
function flxSendKeyword(keyword) {
	if(keyword) {
		if(!keywordsSent[keyword]) {
			sendRequest('//ib.adnxs.com/getuid?https://dm6ndb2k9edja.cloudfront.net/k.gif?pubID=465933&' + '&keyword=' + encodeURIComponent(keyword) + '&AnId=$UID' + '&url=' + encodeURIComponent(encodeURIComponent(window.location.href.split('#')[0].substring(0,500))) + '&ref=' + encodeURIComponent(encodeURIComponent(document.referrer.substring(0, 500))));
